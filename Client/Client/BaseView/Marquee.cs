...
namespace Client.BaseView
{
    /// <summary>
    /// 跑马灯 V 1.0
    /// 来自于 https://github.com/gruan01/XFControls/blob/master/XFControls/Src/AsNum.XFControls/Marquee.cs
    /// </summary>
    public class Marquee : AbsoluteLayout
    {
        ...
        public static readonly BindableProperty ItemTemplateProperty =
            BindableProperty.Create("ItemTemplate", typeof(DataTemplate), typeof(Marquee));
        ...
        public static readonly BindableProperty IntervalProperty =
            BindableProperty.Create("Interval", typeof(int), typeof(Marquee), 3000);
        ...
        private Xamarin.Forms.View GetChildView(object data)
        {
            ...
            if (this.ItemTemplate != null)
            {
                if (this.ItemTemplate != null)
                {
                    view = (Xamarin.Forms.View)this.ItemTemplate.CreateContent();
                }
