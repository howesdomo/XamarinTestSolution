...
{
    public partial class SQLiteDB // SQLiteDB_Inner_Logic.cs -- (通用)各项目内部SQLite数据库
    {
        /// <summary>
        /// 1 初始化数据库结构 和 数据
        /// 2 根据数据库版本号升级数据库结构
        ...
        #region NoteItem - SQLiteDemo演示所用( 位于View-SQLiteDemo )

        public void initNoteItemStructure()
        {
        ...
        public void initBuBuGaoStructure()
        {
